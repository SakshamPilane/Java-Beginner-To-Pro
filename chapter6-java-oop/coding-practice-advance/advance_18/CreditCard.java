...
public class CreditCard implements PaymentMethod{
    private String creditCardNumber, cvv, expiryDate;
    ...
    public void processPayment(String address) {
        ...
        System.out.print("Total price to be paid via UPI 1008.90/- Rs. and your Credit Card is: ");
        System.out.println("Card's last 3 digits = " + getCardHidden(creditCardNumber) + " with CVV = " + cvv);
    }
